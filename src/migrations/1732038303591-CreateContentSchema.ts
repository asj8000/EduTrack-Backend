...
export class CreateContentSchema1732038303591 implements MigrationInterface {
    name = 'CreateContentSchema1732038303591'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`content_version\` ADD CONSTRAINT \`FK_3d2d16fe9ea9872ff36a7c98ef7\` FOREIGN KEY (\`contentId\`) REFERENCES \`content\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`content\` ADD CONSTRAINT \`FK_fc5d23b531c9501ddcdd0ab45f5\` FOREIGN KEY (\`contentTypeId\`) REFERENCES \`content_type\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
    }
